            ...
            do
            {
                ...
                switch (selectedAction)
                {
                    case "1":
                        ...
                        break;
                    case "2":
                        program.CreateNewPerson(databaseContext);
                        break;
                    case "3":
                        program.ReloadDb(databaseContext);
                        break;
                    case "4":
                        ...
                        break;
                    case "5":
                        program.DisplayPeopleTodayBirthday(host);
                        break;
                    case "6":
                        program.DisplayPeopleTomorowBirthday(host);
                        break;
                    case "7":
